...
<html lang="en">
    <head>
        ...
        <title>Voir ton Curriculum</title>
    </head>
    <body>
        <div class="container " >
            <div class="main-content mt-4" style="border: 1px solid;padding:15px; margin:30px 0">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="float:right;">
                                        ...
                                        <h6><b>Site Web : </b> {{$data['basicInfo']->website }}</h6>
                                        <h6><b>Tel : </b> {{$data['basicInfo']->phone }}</h6>
                                    </td> 
                                </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ url('pdf_download')}}" class="btn btn-primary" onclick="return confirm('Etes-vous sur ?')">Telecharger</a>
                    </div>
                </div>
            </div> <!-- main-content -->
        </div> <!-- container -->
