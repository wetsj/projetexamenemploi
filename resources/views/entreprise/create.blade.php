        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>FAIRE UNE OFFRE D'EMPLOI
                        <a href="{{route('home')}}" class="btn btn-danger float-end">Retour</a>
                    </h3>
                </div>
                <div class="card-body">

                    <form class="row g-3" action="{{url('add-postes')}}" method="POST">
                        @csrf
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="prerequis" max="20" class="form-control" cols="30" rows="10"></textarea>
                        </div>
                        <div class="col-md-4">
